...
class Main_Tasks:
    ...
    def re_architect_graph(self, agent):
        description = (
            ...
            "For connecting with llms from huggingface:\n ```from langchain_huggingface import HuggingFaceEndpoint\n llm = HuggingFaceEndpoint(repo_id=[model_name from list],max_new_tokens=1028,verbose=True,top_p=0.95,temperature=0.01,repetition_penalty=1.03,huggingfacehub_api_token='[huggingface_api_key]')\nresponse = llm.invoke(prompt)```\n"
