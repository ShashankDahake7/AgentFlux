...
class Main_Tasks:
    ...
    def re_architect_graph(self, agent):
        description = (
            ...
            "For connecting with llms from huggingface:\n ```from langchain.llms import HuggingFaceHub\n llm = HuggingFaceHub(repo_id='[model_name from list]', model_kwargs=['temperature': 0.5, 'max_length': 64,'max_new_tokens':512]\nresponse = llm.predict(prompt)```[focus on using .predict with huggingface models, .invoke doesn't work here.]\n"
